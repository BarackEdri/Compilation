...
public class AST_DEC_VAR extends AST_DEC
{
	...
	public TEMP IRme()
	{
		IR.getInstance().Add_IRcommand(new IRcommand_Allocate(this.nIR));
		System.out.println("Allocating variable: " + this.nIR + initialValue);	
		if (initialValue != null)
		{
			IR.getInstance().Add_IRcommand(new IRcommand_Store(this.nIR,initialValue.IRme()));
		} 
		return null;
	}
	...
	public TYPE SemantMe()
	{
		...
		/***************************************************/
		this.nIR = SYMBOL_TABLE.getInstance().enter_var(name,t).toString();
