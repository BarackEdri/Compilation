...
public class SYMBOL_TABLE
{
	...
	/****************************************************************************/
	public IRVariableID enter_var(String name,TYPE t)
	{
		/*************************************************/
		...
		/**************************************************************************/
		SYMBOL_TABLE_VAR e = new SYMBOL_TABLE_VAR(name,t,hashValue,next,top,top_index++);
	...
	/***********************************************/
	public IRVariableID find_var(String name)
	{
		...
		for (e = table[hash(name)]; e != null; e = e.next)
		{
			...
			{	
				if (!(e instanceof SYMBOL_TABLE_VAR))
				{
					System.out.println("error in find_var function");
					System.exit(0);
				}
				return ((SYMBOL_TABLE_VAR)e).IR_var;
			}
		}
